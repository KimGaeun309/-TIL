...
// class는 ECMA script 6부터 도입된 문법이다.오늘날 많은 웹프라우저와 Node.js 와 같은 플랫폼들이 ECMA script 6 이상의 버전 지원한다.
// javascript는 원래 객체 지향 언어이므로 새롭게 도입된 문법은 이미 존재하던 기능ㅇ르 변형한 것으로, 기존의 문법으로도 나타낼 수 있다.
